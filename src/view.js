...
const keyMap = {
    "Enter": () => submit.click(),
    "ArrowUp": io => io.moveSelectedIndex(-1),
    "ArrowDown": io => io.moveSelectedIndex(1)
}

class IO {
    constructor(onSubmitChoice, onRestartGame, onLoadCeptre) {
        this.selected = null;
